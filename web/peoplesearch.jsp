...
if(userDetails!=null){
    ArrayList<HashMap> allUserDetails=(ArrayList<HashMap>)session.getAttribute("allUserDetails");
  ...
  <body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3">
				<img src="GetPhoto?email=<%=userDetails.get("email")%>"width="167" height="200">
				</div>
				<div class="col-lg-7">
