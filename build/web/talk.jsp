            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><div class="navbar-text"><p>Welcome: <%=tUserDetails.get("name")%></p></div></li>
		...
		<div class="container text-center">
			<div class="panel panel-default">
				<div class="panel-body text-center">
					<form action="SendMessage" method="post" data-toggle="validator" enctype='multipart/form-data' class="form-horizontal">
						<div class="form-group">
							...
							<div class="panel panel-default">
								<div class="panel-heading text-center">
									<h5><%=userDetails.get("name")%>'s Messages</h5>
                                                                ...
                                                                <%
                                                                ArrayList <HashMap> allMessage=db.getMessage((String)userDetails.get("email"), (String)tUserDetails.get("email"));
							...
							<div class="panel panel-default">
								<div class="panel-heading text-center">
									<h5><%=tUserDetails.get("name")%>'s Messages</h5>
                                                                ...
                                                                <%
                                                                 allMessage=db.getMessage((String)tUserDetails.get("email"), (String)userDetails.get("email"));
